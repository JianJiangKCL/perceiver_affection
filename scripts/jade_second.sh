...
GROUPS=('age' 'gender')
FINETUNE=/jmain02/home/J2AD019/exk04/jxj51-exk04/proj/perceiver_affection/results/baseline_age26/gender/xxx_lr0.004_e60_seedsss_optlamb_bs128_beta0.5_alpha_0.1_gamma_1/last.ckpt
for mode in ${modes[*]}
  do
#    echo $mode
